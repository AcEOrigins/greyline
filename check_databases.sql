-- Check what's in the project management database
SHOW TABLES FROM u775021278_project_manage;

-- Check what's in the users management database  
SHOW TABLES FROM u775021278_users_manage;

-- Move preference tables from project_manage to users_manage
-- Step 1: Create the tables in the correct database
...
-- Step 2: Drop the tables from the wrong database
