...
-- 4. Employee App Preferences and User Data
CREATE TABLE u775021278_project_manage.employee_app_preferences (
    id INT AUTO_INCREMENT PRIMARY KEY,
...
CREATE TABLE u775021278_project_manage.employee_app_data (
    id INT AUTO_INCREMENT PRIMARY KEY,
    employee_id INT NOT NULL,
...
CREATE TABLE u775021278_project_manage.employee_recent_activities (
    id INT AUTO_INCREMENT PRIMARY KEY,
    employee_id INT NOT NULL,
...
CREATE TABLE u775021278_project_manage.employee_bookmarks (
    id INT AUTO_INCREMENT PRIMARY KEY,
    employee_id INT NOT NULL,
